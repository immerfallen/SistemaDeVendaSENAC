...
const routes: Routes = [
  ...
  { path: 'cliente/editar/:id', loadChildren: () => import('./modules/cliente/cliente-editar/cliente-editar.module').then(m => m.ClienteEditarModule) },
  ...
  { path: 'produto/editar/:id', loadChildren: () => import('./modules/produto/produto-editar/produto-editar.module').then(m => m.ProdutoEditarModule) },
